...
### 1
(RLQ=window.RLQ||[]).push(function(){mw.loader.impl(function(){return["user.options@12s5i",function($,jQuery,require,module){mw.user.tokens.set({"patrolToken":"+\\","watchToken":"+\\","csrfToken":"+\\"}); Sefer Ha-yashar, or, the Book of Jasher (1840)/Chapter 84
...
### 41
Mobile view Sefer Ha-yashar, or, the Book of Jasher (1840)/Chapter 84
